...
print("0️⃣ Nettoyage des tables existantes...", flush=True)
print("   Suppression des données joradp_keyword_index...", end=" ", flush=True)
pg_cur.execute("TRUNCATE joradp_keyword_index CASCADE")
pg_conn.commit()
print("✅")

print("   Suppression des données french_keyword_index...", end=" ", flush=True)
pg_cur.execute("TRUNCATE french_keyword_index CASCADE")
pg_conn.commit()
print("✅")
...
# =====================================================
print("\n1️⃣ Migration joradp_keyword_index...", flush=True)
...
start = time.time()
pg_cur.execute("""
    CREATE INDEX IF NOT EXISTS idx_joradp_keyword_doc 
...
start = time.time()
pg_cur.execute("""
    CREATE INDEX IF NOT EXISTS idx_french_keyword_decision 
