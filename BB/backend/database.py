...
from backend.core.db import Base, SessionLocal, db_session as core_db_session, init_db as core_init_db
...
class Document(Base):
    ...
    ai_analysis = relationship(
        "DocumentAIAnalysis", back_populates="document", uselist=False, cascade="all, delete-orphan"
    )
...
def init_db():
    """Backward-compatible init_db wrapper."""
    core_init_db()


# Backward-compatible alias
db_session = core_db_session
